...
public class MainActivity_old extends AppCompatActivity {
    ...
    private void loginHandler() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(
                MainActivity_old.this, R.style.login_layout);
...
//        editPassword.setOnFocusChangeListener((view13, b) -> errorText.setVisibility(View.INVISIBLE));
    ...
    private void postLoginUser() {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, url, jsonBody, response -> {
            ...
            //share the userID
            SharedPreferences sharedPref = getSharedPreferences("my_prefs", MainActivity_old.MODE_PRIVATE);
            ...
            try {
                ...
                if(status.equals("200")) {
                    ...
                    editor.apply();
                    Intent intent = new Intent(MainActivity_old.this, TutorEditInformation.class);
                    startActivity(intent);
                }
    ...
    private void signupHandler() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(
                MainActivity_old.this, R.style.signup_layout);
